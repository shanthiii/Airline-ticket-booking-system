...
<html>
	...
	<body>
		<?php
			//$var =  $_POST['pass_name[0]'];
			//$var1 = $_POST['pass_age[0]'];
			//echo $var1;
			//echo $var;
			//$_SESSION['pass_namee'] = $var;
				...
				*/
				...
				for($i=1;$i<=$no_of_pass;$i++)
				{
					...
					// echo $cnt;
					 ...
					 $name = $_POST['pass_name'][$i-1];
					 $pnr = $_SESSION['pnr'];
					
					$insert = "INSERT INTO `status` VALUES('$name', '$pnr', 'not verified')";
					//$ins ="INSERT INTO `user` VALUES('', '$username', '$password','$mobile_no','$address', '$email')";
					$set = mysqli_query($dbc, $insert);
