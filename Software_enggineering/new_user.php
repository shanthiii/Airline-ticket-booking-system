<html>
	...
	<body>
		...
		<ul>
				...
				<li><a href="Contact_us.html"><i class="fa fa-plane" aria-hidden="true"></i> About us</a></li>
		...
		<form class="center_form" action="new_user_form_handler.php" method="POST" id="new_user_from">
			...
			<table cellpadding='10'>
				...
				<tr>
					...
					<td><input type="text" pattern="^(?=.{8,20}$)(?![_.])(?![@.])(?!.*[_.]{2})[a-zA-Z][0-9._@]+(?<![_.])$" placeholder="Enter 8-20 characters long" name="username" required><br><br></td>
				</tr>
				<tr>
			...
			<table cellpadding='10'>
				...
				<tr>
					...
					<td><input type="text" pattern="^(?=.{8,20}$)[a-zA-Z]" name="name" placeholder="Name" required><br><br></td>
				</tr>
				<tr>
					<td>Enter your phone no.</td>
					<td><input type="number" name="phone_no" placeholder="Phone no" required><br><br></td>
				</tr>
				<tr>
					<td>Enter your address</td>
					<td><input type="text" name="address" placeholder="Address" required><br><br></td>
				</tr>
			</table>
			<br>
