...
<html>
	...
	<body>
		...
		<form action="PNR_enquiry_form_handler.php" method="post">
			<h2>Check the details of your booked flight here</h2>
			<?php
			...
			<table cellpadding="5" style="padding-left: 30px;">
				<tr>
					<td class="fix_table" style="font-size:30px">Enter PNR here</td>
				</tr>
				<tr>
					<td class="fix_table"><input type="text" name="pnr" required></td>
				</tr>
			</table>
			<input type="submit" value="Search" name="Enquiry">
		</form>
