...
<html>
	...
	<body>
		...
		<table cellpadding="5">
			...
			<tr>
				<td class="admin_func"><a href="PNR_enquiry.php"><i class="fa fa-plane" aria-hidden="true"></i> PNR Enquiry</a>
				</td>
			</tr>
			<tr>
				<td class="admin_func"><a href="DUM.php"><i class="fa fa-plane" aria-hidden="true"></i> Profile Management</a>
				</td>
			</tr>
			<tr>
				<td class="admin_func"><a href="id.php"><i class="fa fa-plane" aria-hidden="true"></i>KYC DOCUMENTS</a>
				</td>
			</tr>
		</table>
