	...
	<body>
		...
		<?php
			...
			while($count<=$no_of_pass)
			{
					...
					echo "</tr>";
					echo "<tr>";
					echo "<td class=\"fix_table_short\"><input type=\"text\" onkeypress=\"return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)\" name=\"pass_name[]\" required></td>";
