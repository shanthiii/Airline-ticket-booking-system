...
<html>
	...
	<body>
		...
		<?php
			...
			mysqli_close($dbc);
		?>
		<form action="seat_layout.html">
				<a href="seat_layout.html"><input type="submit" value="Seat Layout" name="Search"></a>
		</form>
		<form action="view_flights_form_handler.php" method="post">
			<h2>Ready To Fly<i class="fa fa-plane"></i></h2>
			<table cellpadding="5">
				<tr>
			...
			<table cellpadding="5">
				...
				<tr>
					...
					<td class="fix_table">
						...
						<select name="no_of_pass" required>
